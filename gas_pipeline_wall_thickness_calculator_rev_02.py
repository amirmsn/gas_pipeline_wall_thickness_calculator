...
dropDesignFactor.config(width=12)
...
dropPipeSpec.config(width=12)

lblCorrosionAllowance = Label(main_window, text="Corrosion allowance: ")
entCorrosionAllowance = Entry(main_window, width=18)
...
lblDisclaimer = Label(main_window, text="This application is made as per the requirments of ASME B31.8 - 2014,"
                      ...
                      "It is still under \ndevelopment. In case of any breakdown or error please contact the \ndeveloper via amirmsn@gmail.com.", justify=LEFT, font="Helvetica 8")
